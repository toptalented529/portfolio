      ...
      <Flex direction={['row', 'column', 'column']}>
        ...
        >
          <MotionBox whileHover={{ scale: 1.5 }} rounded="full" shadow="lg">
            <Avatar
              ...
              icon = {<img style={{"borderRadius":"50%"}} src = "/assets/images/cap.jpg" alt = "here"/>}
            >
        ...
        >
          ...
          <Box as="h2" fontSize="2xl" fontWeight="400" mt={5} textAlign="left">
           I have been working as a Web developer for 8 years in both Front-end and Back-end web development.
           and I have great skill and experience in Blockchain and solidity.As a problem solver who loves facing challenges in my work, I'm excited to be at the deployment phase of my career as a web developer.
